					...
					<div className={styles.productInfo}>
						<div className={styles.carouselAndPreview}>
							<div className={styles.carouselContainer}>
								<button
									className={styles.carouselButtonTop}
									onClick={scrollUp}
									disabled={position <= 0.5}
								>
									<svg
								...
								<button
									className={styles.carouselButtonBottom}
									onClick={scrollDown}
									disabled={
										position >=
										product.images.length -
											visibleCaruselElements -
											0.5
									}
								>
									<svg
						...
						<div className={styles.productSpecs}>
							...
							<ul className={styles.productSpecsList}>
								{targetSpecs.map((target) => {
									const spec = product?.characteristics?.find(
							...
							{isOpen && (
								<ul className={styles.productSpecsList}>
									{product?.characteristics
										?.filter(
											(spec) =>
												!targetSpecs.includes(spec.name)
										)
										.map((spec) => (
											<li
												className={
